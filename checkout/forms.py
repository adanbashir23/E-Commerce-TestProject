    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                "Shipping Details",
                Div(
                    Field("shipping_name", wrapper_class="col-12 col-md-6"),
                    Field("shipping_address", wrapper_class="col-12 col-md-8"),
                    Field("shipping_post_code", wrapper_class="col-12 col-md-4"),
                    Field("shipping_city", wrapper_class="col-12 col-md-6"),
                    Field("shipping_country", wrapper_class="col-12 col-md-6"),
                    css_class="row",
                ),
            ),
        )
